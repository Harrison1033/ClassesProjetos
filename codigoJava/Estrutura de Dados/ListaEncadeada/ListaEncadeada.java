public class ListaEncadeada<T> {
    ...
    public T remove(int index){
        validaIndice(index);//Usado pra validar o índice no decorrer do programa
    ...
    private void validaIndice(int index){//Usado pra validar o índice no decorrer do programa
        if(index >= size()){
