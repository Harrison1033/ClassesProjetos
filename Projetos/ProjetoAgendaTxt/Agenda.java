...
//	Map de contatos. A chave é o nome do contato e o valor é o próprio objeto Contato.
	 ...
	 * A chave é a letra e o valor é uma lista de contatos, cujo nome começa com a
	 * letra especificada na chave do map.
	 */
	...
	/**Construtor. Ao criar o objeto, os registros cadastrados no arquivo são lidos
	 * e adicionados à agenda (caso existam)
	 * @throws IOException
	 */
